...
export function generateRestaurantSchema() {
  return {
    ...
    name: BUSINESS.name, image: `${site}/flospizza.png`,
    ...
    telephone: BUSINESS.phoneE164, url: site,
...
export function generateOrganizationSchema() {
  return {
    ...
    name: BUSINESS.name, url: site, logo: `${site}/flospizza.png`,
...
export function generateWebSiteSchema() {
  return { "@context": "https://schema.org", "@type": "WebSite", name: BUSINESS.name, url: site, publisher: { "@type": "Organization", name: BUSINESS.name, url: site } }
}
