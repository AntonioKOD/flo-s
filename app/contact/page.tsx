    ...
    <main className="w-full min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display text-foreground mb-4">
              Contact <span className="text-[#C1272D]">Us</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 py-12">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-display">Hours</h2>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-display">Contact</h2>
              </div>
              <div className="space-y-4">
      ...
      <section className="w-full py-12 md:py-16 px-4 sm:px-6 md:px-16 lg:px-20 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2964.5!2d-71.0184!3d42.0834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e4613b2becbeb9%3A0xflos_pizza_brockton!2s750+Centre+St%2C+Brockton%2C+MA+02302!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
