  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-card/80 dark:bg-card/80",
        className
      )}
    >
      {children}
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <Image src={floslogo} alt="Flo's Pizza Logo" width={70} height={70} />
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    dark:
      "bg-foreground text-background shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    gradient:
      "bg-gradient-to-b from-primary to-accent text-primary-foreground shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
